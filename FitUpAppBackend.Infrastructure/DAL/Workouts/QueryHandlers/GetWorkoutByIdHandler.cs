...
public sealed class GetWorkoutByIdHandler : IQueryHandler<GetWorkoutByIdQuery, WorkoutDto>
{
    private readonly EFContext _context;
    private readonly ICurrentUserService _currentUserService;

    public GetWorkoutByIdHandler(EFContext context, ICurrentUserService currentUserService)
    {
        _context = context;
