    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SetParameterNames", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "ExerciseSetParameterName",
                columns: table => new
                {
                    ExercisesId = table.Column<Guid>(type: "uuid", nullable: false),
                    SetParametersId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExerciseSetParameterName", x => new { x.ExercisesId, x.SetParametersId });
                    table.ForeignKey(
                        name: "FK_ExerciseSetParameterName_Exercises_ExercisesId",
                        column: x => x.ExercisesId,
                        principalTable: "Exercises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExerciseSetParameterName_SetParameterNames_SetParametersId",
                        column: x => x.SetParametersId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SetParameters", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExerciseSetParameterName_SetParametersId",
                table: "ExerciseSetParameterName",
                column: "SetParametersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SetParameters_WorkoutSetId",
                table: "SetParameters",
                column: "WorkoutSetId");
